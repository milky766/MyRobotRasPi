...
(このゲインがベスト)→
uv run python apps/pid_tune.py step --step-q0 0 --step-q1 20 --total 8 --kp 0.15 --ki 0.25 --kd 0.01 --encoder --zero-at-start -v
...
uv run python apps/pid_tune.py evaluate --traj random --amp 20 --offset 20 --dwell 1.0 --t-total 8 --kp 0.15 --ki 0.25 --kd 0.01 --encoder --zero-at-start --pre-check -v
"""
